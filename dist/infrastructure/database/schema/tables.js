...
export const branches = pgTable("branches", {
    ...
    areaCoords: jsonb("area_coords").$type(),
...
export const attendance = pgTable("attendance", {
    ...
    checkInBypass: jsonb("check_in_bypass").$type(),
    checkOutBypass: jsonb("check_out_bypass").$type(),
    ...
    check("attendance_checkout_status_check", sql.raw(`checkout_status is null or checkout_status in (${Object.values(CheckoutStatus)
        .map((v) => `'${v}'`)
        .join(', ')})`)),
