    ...
    async run() {
        ...
        await this.locks.withLockBlocking('schema-migrations', async () => {
            ...
            if (!existsSync(MIGRATIONS_DIR)) {
                throw new Error(`no migrations directory at ${MIGRATIONS_DIR} — the deployment is missing db/`);
            }
...
MigrationService = __decorate([
    ...
    __metadata("design:paramtypes", [Object, AdvisoryLockService])
], MigrationService);
