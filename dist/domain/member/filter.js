...
export function directoryWhere(o) {
    ...
    if (o.branchId)
        conds.push(sql `d.branch_id = ${o.branchId}`);
    ...
    if (o.bypass_face)
        conds.push(sql `d.bypass_face = true`);
    if (o.bypass_location)
        conds.push(sql `d.bypass_location = true`);
    if (o.frozen)
        conds.push(sql `d.frozen_at is not null`);
    if (o.has_face !== undefined)
        conds.push(sql `d.has_face = ${o.has_face}`);
    if (o.is_active !== undefined)
        conds.push(sql `d.is_active = ${o.is_active}`);
