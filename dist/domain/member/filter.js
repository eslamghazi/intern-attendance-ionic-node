 ...
 */
export function searchColumn(field) {
 ...
 */
export function directoryWhere(o) {
    const conds = [];
    ...
    if (o.bypass_face)
        conds.push(eq(memberDirectory.bypassFace, true));
    if (o.bypass_location)
        conds.push(eq(memberDirectory.bypassLocation, true));
    if (o.frozen)
        conds.push(isNotNull(memberDirectory.frozenAt));
    if (o.has_face !== undefined)
        conds.push(eq(memberDirectory.hasFace, o.has_face));
    if (o.is_active !== undefined)
        conds.push(eq(memberDirectory.isActive, o.is_active));
    if (o.departmentId && o.year && o.month) {
        conds.push(exists(qb
 ...
 */
export function filteredMemberIds(o) {
    return qb
...
export function filteredProfileIds(o) {
    return qb
 ...
 */
export function dayInMonth(first, day) {
