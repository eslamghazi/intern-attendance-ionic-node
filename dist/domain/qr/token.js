...
export function qrAllowed(method, branchQrEnabled) {
...
export function checkinBlocked(method, branchBlocked) {
 ...
 */
export function planMint(req, settings) {
    if (!req.branchId)
