...
import { classifyRefresh, expiresInSeconds, expiryFrom } from './refresh.js';
...
describe('classifyRefresh', () => {
    ...
    it('flags reuse even once the replayed token has expired', () => {
        ...
        expect(classifyRefresh(token({ rotatedAt: new Date('2026-08-01T12:00:00Z'), expiresAt: new Date('2026-08-31T12:00:00Z') }), NOW)).toEqual({ kind: 'reuse', familyId: FAMILY });
    });
