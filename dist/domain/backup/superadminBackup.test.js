...
import { parseSuperadminBackup, SUPERADMIN_BACKUP_KIND, SUPERADMIN_BACKUP_VERSION, } from './superadminBackup.js';
const account = (over = {}) => ({
...
describe('parseSuperadminBackup', () => {
    ...
    describe('refuses an account it could only half-insert', () => {
        ...
        it('with no password hash', () => {
            ...
            expect(why(file({ accounts: [account({ password_hash: null })] }))).toMatch(/no password_hash/);
        });
...
//# sourceMappingURL=superadminBackup.test.js.map