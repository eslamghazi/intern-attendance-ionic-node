...
import { mayTouchAttachment, pathOwner } from './attachment.js';
import { Role } from '../../common/enums/index.js';
const A = 'aaaaaaaa-0000-0000-0000-00000000000a';
const B = 'bbbbbbbb-0000-0000-0000-00000000000b';
const may = (bucket, path, action, callerId, role = Role.MEMBER) => mayTouchAttachment({ bucket, path, action, callerId, role });
describe('pathOwner', () => {
...
describe('faces and probes', () => {
    for (const bucket of ['faces', 'probes']) {
