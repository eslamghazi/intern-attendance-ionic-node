...
import { adminScope, coversRequestedFilter, coversUnit } from './scope.js';
...
describe('coversUnit', () => {
    const assigned = { kind: 'assigned', branchIds: [BRANCH_A], groupIds: [GROUP_1] };
