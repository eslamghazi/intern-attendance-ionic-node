...
describe('initialPassword', () => {
    ...
    it('gives staff no fallback at all', () => {
        ...
        expect(initialPassword({ role: Role.ADMIN, nationalId: '29901010101234', passwordHash: null })).toBeNull();
        expect(initialPassword({ role: Role.SUPERADMIN, nationalId: '29901010101234', passwordHash: null })).toBeNull();
    });
});
