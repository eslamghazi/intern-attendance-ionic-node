...
import { buildReportHtml, type ReportDocument } from './report-html.js';
import type { ReportFormat } from './export.types.js';
export type { ReportFormat } from './export.types.js';
 ...
 */
export function parseFormat(raw: string | undefined): ReportFormat {
