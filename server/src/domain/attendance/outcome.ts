...
import type { AttendanceOutcome, SlotFacts } from './types.js';
export type { AttendanceOutcome, SlotFacts } from './types.js';
 ...
 */
export function attendanceOutcome(slot: SlotFacts): AttendanceOutcome {
...
export function outcomeAttended(outcome: AttendanceOutcome): boolean {
  return outcome.startsWith('present_') || outcome.startsWith('late_');
}

/** Does this outcome count toward a rate's denominator? */
export function outcomeCounts(outcome: AttendanceOutcome): boolean {
