...
export function memberCodePrefix(year: number, institutionCode: number): string {
 ...
 * code.
 */
export function composeMemberCode(year: number, institutionCode: number, serial: number): string {
 ...
 */
export function memberCodeSerial(code: string | null | undefined): number | null {
 ...
 * cohort is reissued.
 */
export function codeMatchesCohort(
 ...
 */
export function reissueNeeded(
  currentCode: string | null | undefined,
  cohort: { year: number | null; institutionCode: number } | null,
): boolean {
  ...
  // return new`.
  if (!cohort || cohort.year === null) return false;
