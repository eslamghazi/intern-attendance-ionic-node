...
import type { OpRequirement, PageRequirement } from '../../domain/identity/permissions.js';

export const PAGE_KEY = 'page';
export const ANY_STAFF_KEY = 'anyStaff';

/** What a route stores about the grant it needs. */
export interface PageRequirementMetadata {
 ...
 */
export const Page = (pages: PageRequirement, op?: OpRequirement) =>
  SetMetadata<string, PageRequirementMetadata>(PAGE_KEY, { pages, op });
